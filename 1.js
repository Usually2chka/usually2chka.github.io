    ...
    pt.specs.backgroundColor = 'rgba(31, 31, 31, 1)';
    //ctx.setLineDash([4, 3]);
    ...
    function Info(ctx, e, cell, col1, col2){
        ...
        ctx.fillText('Атомный номер:                 '+e.atomicNumber, 220, 58);
        ctx.fillText('Масса:                                   '+e.mass+' a.e.m.', 220, 75);
        ctx.fillText('Ковалентный радиус:        '+e.covalentRadius+' \u212B', 220, 92);
        ctx.fillText('vdW Радиус:                         '+e.vdWRadius+' \u212B', 220, 109);
    }
